 ...
 *  @return     error status of the initialization, defined in "SSerrors.h".
 */
int cspaceADCS_getRawCam2Sensor(unsigned char index, cspace_adcs_rawcam2_t* raw_cam2);
 ...
 *  @return     error status of the initialization, defined in "SSerrors.h".
 */
int cspaceADCS_getRawCam1Sensor(unsigned char index, cspace_adcs_rawcam1_t* raw_cam1);
 ...
 *  @return     error status of the initialization, defined in "SSerrors.h".
 */
int cspaceADCS_getRawGpsX(unsigned char index, cspace_adcs_rawgpsx_t* raw_gps_x);
 ...
 *  @return     error status of the initialization, defined in "SSerrors.h".
 */
int cspaceADCS_getRawGpsY(unsigned char index, cspace_adcs_rawgpsy_t* raw_gps_y);
 ...
 *  @return     error status of the initialization, defined in "SSerrors.h".
 */
int cspaceADCS_getRawGpsZ(unsigned char index, cspace_adcs_rawgpsz_t* raw_gps_z);
