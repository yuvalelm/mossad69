...
static Boolean selectAndExecuteTRXVUDemoTest(void)
{
	...
	printf("\t 10) (revD) Get receiver telemetry \n\r");
	printf("\t 11) (revD) Get transmitter telemetry \n\r");
	printf("\t 12) (revC) Get receiver telemetry \n\r");
	printf("\t 13) (revC) Get transmitter telemetry \n\r");
